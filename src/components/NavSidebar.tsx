...
import {
  ...
  Bell, Settings, ShieldCheck, ChevronLeft, ChevronRight, ChevronDown, Workflow, ShieldAlert, Lightbulb, Library, Bot, Compass, Network, ClipboardList, FolderKanban, Receipt, Radar, Cpu, Dices, Microscope, Truck, LifeBuoy, TrendingDown, FileWarning, Award, Inbox, Milestone
} from 'lucide-react'
...
const ICON_MAP: Record<string, LucideIcon> = {
  dash: LayoutDashboard, crm: Target, feed: FlaskConical, projects: ListChecks, lifecycle: Milestone,
