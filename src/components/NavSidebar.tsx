...
import {
  ...
  Bell, Settings, ShieldCheck, ChevronLeft, ChevronRight, Workflow, ShieldAlert, Lightbulb, Library, Bot, Compass, Network, ClipboardList, FolderKanban, Receipt, Radar, Cpu
} from 'lucide-react'
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  team: Users, portfolio: Wallet, predict: Sparkles, focus: Compass, coordination: Network, executive: ClipboardList, portfolioiq: FolderKanban, billing: Receipt, actions: Zap, field: Hammer, fieldai: Radar, autopilot: Cpu,
