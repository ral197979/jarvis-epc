...
import {
  ...
  Bell, Settings, ShieldCheck, ChevronLeft, ChevronRight, Workflow, ShieldAlert, Lightbulb, Library, Bot, Compass, Network
} from 'lucide-react'
...
const ICON_MAP: Record<string, LucideIcon> = {
  ...
  team: Users, portfolio: Wallet, predict: Sparkles, focus: Compass, coordination: Network, actions: Zap, field: Hammer,
