...
export const MCP_CATEGORY_COLOR: Record<MCPToolCategory, string> = {
  ...
  AI:          'var(--jarvis-blue)',
  Analytics:   'var(--jarvis-amb)',
  Field:       'var(--jarvis-grn)',
  Engineering: 'var(--jarvis-pur)',
  Documents:   'var(--jarvis-td)',
}
...
// ─── Marketplace Tools (G4) ───────────────────────────────────────────────────

export const MARKETPLACE_TOOLS: MCPTool[] = [
  { name: 'cost_analytics_v2',  desc: 'Real-time cost tracking and variance analytics with EVM integration',        cat: 'Analytics',    params: ['project_id', 'period'],                              source: 'marketplace', publisher: 'CostIQ',        version: '2.1.0', enabled: false },
  { name: 'drone_site_imagery', desc: 'Drone capture integration — upload and geo-tag site progress photos',        cat: 'Field',        params: ['project_id', 'flight_id', 'lat', 'lng'],             source: 'marketplace', publisher: 'AerialOps',     version: '1.0.3', enabled: false },
  { name: 'contract_redline',   desc: 'AI-assisted contract redlining and clause comparison',                       cat: 'Documents',    params: ['contract_id', 'baseline_id'],                        source: 'marketplace', publisher: 'LegalAI',       version: '3.0.1', enabled: false },
  { name: 'structural_calc',    desc: 'Structural load and beam calculation with code compliance',                  cat: 'Engineering',  params: ['element_type', 'load_case', 'material'],             source: 'marketplace', publisher: 'StructCalc',    version: '1.2.0', enabled: false },
  { name: 'weather_integration',desc: 'Live weather data correlated with daily logs and schedule delays',          cat: 'Field',        params: ['project_id', 'date_range'],                          source: 'marketplace', publisher: 'WeatherBridge', version: '1.0.0', enabled: false },
  { name: 'erp_sync',           desc: 'Bi-directional sync with SAP, Oracle, and MS Dynamics financials',         cat: 'System',       params: ['erp_type', 'entity_type', 'direction'],              source: 'marketplace', publisher: 'ERPLink',       version: '2.5.0', enabled: false },
]
