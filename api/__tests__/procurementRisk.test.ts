...
describe('Procurement risk route', () => {
  ...
  it('GET /projects/:id/procurement-risk returns risk + vendor rollup', async () => {
    ...
    const res = await request(makeApp()).get('/api/v1/projects/30000000-0000-4000-8000-000000000001/procurement-risk')
  ...
  it('404s for an unknown project', async () => {
    ...
    const res = await request(makeApp()).get('/api/v1/projects/30000000-0000-4000-8000-0000000000ff/procurement-risk')
