...
// ADR-014 Phase 2B-1: GET /copilot/portfolio is a cross-project roll-up, so it requires `portfolio.view` — a capability Phase 1 grants to the tenant owner alone.
