...
describe('Cost Intelligence route', () => {
  ...
  it('GET /projects/:id/cost-intelligence returns the analysis', async () => {
    ...
    const res = await request(makeApp()).get('/api/v1/projects/30000000-0000-4000-8000-000000000001/cost-intelligence')
  ...
  it('404s for an unknown project', async () => {
    ...
    const res = await request(makeApp()).get('/api/v1/projects/30000000-0000-4000-8000-0000000000ff/cost-intelligence')
