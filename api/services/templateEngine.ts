/**
 * Denver Engineering — Commissioning Pack Template Engine
 * ─────────────────────────────────────────────────
 * v4.30.0 | Bridges EngineeringHub v11 pack generation to DenverEngineering rules.ts
 *
 * Replaces EngineeringHub's static 5-type library with DenverEngineering's rules engine,
 ...
 *   EngineeringHub → DenverEngineering rules key
 *   'chiller'      → 'chiller'
...
export function buildDraftPack(
  ...
  const notes: string[] = [
    `Draft generated by Denver Engineering v4.30.0 — system type: ${normType}`,
